...
/**
 * Created by Frank on 10/17/2014.
 */
public class Map {
    ...
    private void unloadChunks(int player_chunk_x, int player_chunk_y) {
        for (Chunk chunk : loadedChunks){
            if (chunk.CHUNK_X > player_chunk_x + (References.CHUNK_AMOUNT_X-1)/2 ||
                    chunk.CHUNK_X < player_chunk_x - (References.CHUNK_AMOUNT_X)/2 ||
                    chunk.CHUNK_Y > player_chunk_y + (References.CHUNK_AMOUNT_Y-1)/2 ||
                    chunk.CHUNK_Y < player_chunk_y - (References.CHUNK_AMOUNT_Y)/2){
    ...
    private void loadChunks(int player_chunk_x, int player_chunk_y) {
        for (int x = player_chunk_x - (References.CHUNK_AMOUNT_X-1)/2;
             x <= player_chunk_x + (References.CHUNK_AMOUNT_X-1)/2; x++){
            for (int y = player_chunk_y - (References.CHUNK_AMOUNT_Y-1)/2;
                 y <= player_chunk_y + (References.CHUNK_AMOUNT_Y-1)/2; y++){
